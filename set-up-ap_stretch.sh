...
#This scripts creates an Access Point out a the first wireless network adapter you have 
...
echo "sudo ip link set eth0 up&" >> /etc/rc.local
echo "sudo dhclient eth0&" >> /etc/rc.local
